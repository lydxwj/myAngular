	...
	_renderHTML: function(cfg) {
		...
		if(curIndex > -1){
			...
			if(_cache.onlyFlag) {
				...
				$('.auto-tip',cfg.parentNode).css({'position':'absolute','top':'1.4rem','width':cfg.width - 2 + 'px','left':'5.1rem','background-color':'rgba(204, 204, 204, 0.75)','height':'4rem','overflow-y':'auto',
