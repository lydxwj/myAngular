...
function EmailAutoComplete(options) {
    this.config = {
        ...
        mailArr        : ["@qq.com","@163.com","@126.com","@sina.com","@hotmail.com","@yahoo.com","@yahoo.com.cn","@live.com","@sohu.com","@gmail.com"], //邮箱数组
    ...
    _renderHTML: function(cfg) {
        ...
        if(curIndex > -1){
            ...
            if(_cache.onlyFlag) {
                ...
                $('.auto-tip',cfg.parentNode).css({'position':'absolute','top':'1.4rem','width':cfg.width - 2 + 'px','left':'4.1rem','background-color':'rgba(204, 204, 204, 0.75)','height':'4rem','overflow-y':'auto',
